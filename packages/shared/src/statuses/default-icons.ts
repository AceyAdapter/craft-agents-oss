...
export const DEFAULT_ICON_SVGS: Record<string, string> = {
  ...
  <path d="M8 12l3 3 5-5" fill="none" stroke="var(--status-glyph, white)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
</svg>`,
  ...
  <circle cx="12" cy="12" r="10" />
  <path d="M9 9l6 6M15 9l-6 6" fill="none" stroke="var(--status-glyph, white)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
</svg>`,
};
